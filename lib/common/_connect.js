...
exports.importDB = function importDB (path = './db.json') {
  ...
  try {
    ...
    ps.push(db.users.update({ _id: '2' }, { _id: '2', username: 'Invader', usernameLower: 'invader', cpu: 100, cpuAvailable: 10000, gcl: 13966610.2, active: 0 }, { upsert: true }))
    ps.push(db.users.update({ _id: '3' }, { _id: '3', username: 'Source Keeper', usernameLower: 'source keeper', cpu: 100, cpuAvailable: 10000, gcl: 13966610.2, active: 0 }, { upsert: true }))
    return Promise.all(ps)
